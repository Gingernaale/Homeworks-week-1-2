...
class Orange {
    ...
    init(color: String, taste: String, weight: Float) {
        self.color = color
        self.taste = taste
        self.weight = weight
    }
...
class Rectangle : Figure {
    ...
    func description(){
        return print("Rectangle area is: \(squareOfFigure()), and perimeter Of Figure is: \(perimeterOfFigure())")
    }
}

let myrectangle = Rectangle(height: 3.5, width: 4)
